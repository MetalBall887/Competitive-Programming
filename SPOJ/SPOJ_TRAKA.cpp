...
//the car with complexity (f) = 1 moves out of the i-th worker's place if it moves out of first one's in time 0. 
//b_i will be the same: the time when the i-th coworker gets the car with f = 1. 
//So when Mirko gets the j-th car, if there is a such i
//a_i * f_j-1 - b_i * f_j > 0, Mirko will have to wait this amount of time, because the car j will appear at i-th worker's
//workplace sooner than he'll finish j-1st. So out of i he has to take the maximal
