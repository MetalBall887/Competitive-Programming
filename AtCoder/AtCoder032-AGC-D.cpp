...
//another one between them. Now we can add baskets. We put our elements in baskets without changing the order. There are
...
//one operation, when |_(2)_| |_(3)_| |_(1)_| |_(4)_| |_(5)_| here it will be three. Also it will be sometimes more optimal 
//to put the element on the other side of corresponing box. To find the best way, we can do d[i][j] - the cost of sorting i 
//first elements into first j baskets.
#include <algorithm>
#include <cstring>
#include <cstdlib>
#include <cmath>
